        ...
        >
          ...
          {isUsersError && (
            <Alert severity="error" sx={{ m: 2 }}>
              {getFriendlyErrorMessage(usersFetchError, "Failed to load users.")}
            </Alert>
          )}
                ...
                paginatedUsersData?.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="left">
                      {row.roleModel?.name ?? row.role ?? "—"}
                    </TableCell>
                    <TableCell align="right">
                      {row.jobPosition ?? row.city ?? "—"}
                    </TableCell>
                    <TableCell align="center">
                      {(row.status === "active" || row.availability) ? (
                        <Chip
                          label="Active"
                          sx={{
